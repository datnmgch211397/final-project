...
class _ChatScreenState extends State<ChatScreen> {
  ...
  ValueNotifier<String?> selectedImageUrlNotifier =
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      final imageUrl =
          await chatController.uploadImage(selectedImageFileNotifier.value!);
                          ...
                          children: [
                                ...
                                if (selectedImageFile != null) {
                                  return Positioned(
                                    ...
                                    child: Image.file(
                                      selectedImageFile,
                                      height:
                                          50, // Set the height to make the image smaller
                                    ),
                                  );
                                }
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  left: selectedImageFileNotifier.value != null
                                      ? 60
                                      : 0),
                                ...
                                builder: (context, selectedImageFile, child) {
                                  return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: selectedImageFile != null
                                          ? ''
                                          : 'Enter your message',
                                    ),
                                  );
